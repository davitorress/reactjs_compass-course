...
const SimpleInputs = (props) => {
	...
	let emailErrorMessage = "E-mail must contain an @ and cannot be empty.";
	if (enteredEmail.trim() !== "" && !enteredEmail.includes("@")) emailErrorMessage = "E-mail must contain an @.";
	...
	return (
		<form onSubmit={formSubmissionHandler}>
			...
			<div className={emailInputClasses}>
				...
				{emailInputHasError && <p className="error-text">{emailErrorMessage}</p>}
			</div>
